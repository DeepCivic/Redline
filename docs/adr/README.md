...
| [0014](./0014-embeddings-cross-the-json-boundary-as-float-arrays.adr.md) | Embeddings cross the JSON boundary as plain float arrays on a sibling resource | Accepted — amendment **proposed** in [0017](./0017-bulk-womblex-data-stays-parquet-json-is-for-presentation.adr.md)/[0018](./0018-retrieval-is-a-store-side-query-surface.adr.md) |
