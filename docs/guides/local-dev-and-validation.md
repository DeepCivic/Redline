...
arrives with hundreds of cosmetic findings gets switched off. To run it alone:
`pipx run ruff check services/womblex-ingest`.

Static checks (4, 7-9, 11) always run on the host. If neither local Node nor Podman
