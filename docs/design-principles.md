...
> ([0007](./adr/0007-procurement-purpose-lens-means.adr.md)–[0009](./adr/0009-numbatch-library-is-system-of-record.adr.md),
> [0010](./adr/0010-topic-identity-carries-into-the-requirement-projection.adr.md),
> [0011](./adr/0011-hard-rule-precedence-is-specificity-then-declaration-order.adr.md),
> [0014](./adr/0014-embeddings-cross-the-json-boundary-as-float-arrays.adr.md));
...
- **A missing overlay falls back — ordering, not dependency.** In womblex, `chunk`
  ...
  is the mechanism behind [ADR-0008](./adr/0008-trained-classifier-is-an-optional-overlay.adr.md).)
...
- **Air-gap / offline operation.** Retrieval requires Isaacus; a deployment that
  cannot reach it cannot retrieve. (See [ADR-0008](./adr/0008-trained-classifier-is-an-optional-overlay.adr.md),
